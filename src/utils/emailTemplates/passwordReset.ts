...
export const passwordResetHtml = (name: string, token: string) => baseLayout(`
  ...
  <tr>
    <td style="padding: 16px 40px 0; max-width: 366px; margin: 0 auto;" class="card-inner">
      ...
      <p style="color: #666666; font-size: 16px; line-height: 1.6; margin: 12px 0 0; font-family: 'Geist', Arial, Helvetica, sans-serif;" class="card-text">We received a request to reset your password. Use the reset code below to set a new password.</p>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="padding: 12px 40px 0; max-width: 366px; margin: 0 auto;" class="card-inner">
      <p style="color: #888888; font-size: 14px; line-height: 1.5; margin: 0; font-family: 'Geist', Arial, Helvetica, sans-serif;" class="card-text">This code expires in 1 hour.</p>
    </td>
  </tr>
  `,
  `
