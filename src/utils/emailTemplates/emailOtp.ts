    ...
    <tr>
      <td style="padding: 32px;">
        ...
        <div style="text-align: center; margin: 24px 0;">
          <span style="display: inline-block; font-size: 36px; font-weight: bold; letter-spacing: 8px; color: #4F46E5; background: #f0f0ff; padding: 16px 32px; border-radius: 8px;">${otp}</span>
        </div>
        <p style="font-size: 16px; color: #333; line-height: 1.6;">This code expires in 10 minutes.</p>
